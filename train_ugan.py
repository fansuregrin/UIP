...
parser.add_argument("--net_cfg", type=str, default="configs/network/ugan_01.yaml")
...
parser.add_argument("--lambda_l1", type=float, default=100, help="weight of L1 Loss")
parser.add_argument("--lambda_gp", type=float, default=10, help="weight of Gradient Penalty")
parser.add_argument("--lambda_gd", type=float, default=1, help="weight of Gradient Difference Loss")
parser.add_argument("--val_interval", type=int, default=100, help="how many iterations to validate the model")
parser.add_argument("--ckpt_interval", type=int, default=20, help="how many epochs to save checkpoint")
