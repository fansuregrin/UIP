...
from networks.utuie.loss.LAB import lab_Loss
from networks.utuie.loss.LCH import lch_Loss
from networks.utuie.net.utils import VGG19_PercepLoss
...
class UTUIE(BaseModel):
    ...
    def _set_loss_fn(self):
        ...
        self.lch_loss_fn = lch_Loss().to(self.device)
