...
parser.add_argument("--ds_cfg", type=str, default="configs/dataset/lsui_waternet.yaml")
parser.add_argument("--lr_scheduler_cfg", type=str, default="configs/lr_scheduler/none.yaml")
parser.add_argument("--net_cfg", type=str, default="configs/network/waternet_01.yaml")
...
parser.add_argument("--lambda_percep", type=float, default=0.5, help="weight of Perceptual loss")
