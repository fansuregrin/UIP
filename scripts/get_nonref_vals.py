...
if num_epoch > 1:
    ...
    for ds_name in ds_name_list:
        ...
        for metric in metric_names:
            ...
            avg_fmt_row_str += '{:<10.3f}'.format(epoch_avg_val)
            info_ds_avg += '{:<10.3f}'.format(epoch_avg_val)
        info_ds_avg += '\n'
    ...
    for metric in metric_names:
        info_ds_avg += '{:<10.3f}'.format(ds_metrics_sum[metric]/len(ds_name_list))
    info_ds_avg += '\n'
    info_ds_avg += ('=' * (len(metric_names) * 10 + 15) + '\n')
    ...
    for metric in metric_names:
        avg_fmt_row_str += '{:<10.3f}'.format(metric_sums[metric]/len(ds_name_list))
